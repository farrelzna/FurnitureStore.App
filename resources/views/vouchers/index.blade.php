            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-2">
                        <form class="flex max-w-sm mx-auto items-center" role="search" action="{{ request()->route('vouchers')}}" method="GET">   
                            ...
                            <table class="min-w-full bg-white">
                                <thead class="rounded">
                                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal rounded">
                                        ...
                                        <th class="py-3 px-6 text-left">Discount (Price)</th>
                                    </tr>
                                </thead>
                                <tbody class="text-gray-600 text-sm">
                                    @foreach ($voucher as $item)
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                                            <td class="py-3 px-6">{{ $item->name }} <br> 
                                                <div class="flex space-x-2"> <!-- Flex container -->
                                                    <div class="flex gap-2">
                                                        <a href="{{ route('vouchers.edit', $item) }}">
                                                        ...
                                                        <form action="{{ route('vouchers.delete', $item->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
